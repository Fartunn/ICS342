...
/**
 * Please note that you will need both of these extensions if you are testing coroutines and
...
class MainViewModelTest {
    ...
    fun `login() should fail with incorrect credentials`() = runTest {
        /**
         * Mock ApiService to throw an exception when login is called with incorrect credentials
         */
        val api = mockk<ApiService>()
        ...
        /**
         * Assert that the User object in the view model remains null after a failed login attempt
         */
         ...
         * Verify that the api service login function was called with the correct arguments.
         */
        coVerify { api.login("wrongUsername", "wrongPassword") }
    }
}
